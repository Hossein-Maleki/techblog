  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      body: SingleChildScrollView(
        child: Obx(
          () => _singelArticelsController.singelArticel.value.title == null
              ? genLoding()
              : Column(
                  children: [
                    Stack(
                      children: [
                        CachedNetworkImage(
                            imageUrl: _singelArticelsController
                                .singelArticel.value.image!,
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () async {
                                  var tagId = _singelArticelsController
                                      .tagslist[index].id!;
